$(document).ready(function(){
  ...
  const searchableContent = [
    ...
    { 
      ...
      content: 'Proses pengadaan di proyek EPC migas biasanya terstruktur dan mengikuti beberapa tahapan utama. Perencanaan dan Strategi Pengadaan. Tahap awal ini melibatkan tim proyek untuk menentukan jenis material dan jasa apa saja yang dibutuhkan. Permintaan Penawaran (Request for Quotation/RFQ). tim procurement akan mengirimkan RFQ kepada vendor yang telah lolos kualifikasi. Dokumen ini berisi spesifikasi teknis yang sangat detail. Evaluasi Penawaran. Tim procurement, bersama dengan tim teknis, akan mengevaluasi semua penawaran yang masuk. Evaluasi ini tidak hanya fokus pada harga, tetapi juga pada aspek teknis.' 
    }
  ];
